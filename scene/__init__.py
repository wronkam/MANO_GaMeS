...
class Scene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None,
        ...
        elif os.path.exists(os.path.join(args.source_path, "masks_removeblack")):
            print("Found masks_removeblack dir, assuming InterHand data set!")
            scene_info = sceneLoadTypeCallbacks["InterHand"](args.source_path, args.white_background, args.inter_frame_no)
        else:
