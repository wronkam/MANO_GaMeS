"""
Demo code to load the MANO Layer and visualise the 3D landmarks on the Face
...
More information about MANO is available at http://flame.is.tue.mpg.de.
...
# Forward  Pass of MANO, one can easily use this as a layer in a Deep learning Framework
